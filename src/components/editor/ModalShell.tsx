      ...
      {isOpen && (
        <div className="fixed inset-0 z-[60] flex items-end sm:items-center justify-center sm:p-4">
          ...
          <motion.div
            ...
            className="relative w-full max-w-lg bg-milk-tea-50 rounded-t-3xl sm:rounded-3xl shadow-2xl overflow-hidden flex flex-col max-h-dvh sm:max-h-[90vh]"
          >
            {/* Header */}
            ...
            {footer && (
              <div
                className="px-6 pt-4 border-t border-milk-tea-200 bg-white/50 backdrop-blur-md sticky bottom-0 z-10"
